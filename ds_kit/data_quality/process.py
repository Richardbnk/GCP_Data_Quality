...
class Process:
    ...
    def finish_process(self):
        # , ds_execution_status, ds_observation=None, ds_error_type=None, ds_last_executed_task=None):

        # build status
        # self.ds_execution_status = ds_execution_status

        # build observation
        # self.ds_observation = ds_observation

        # error type
        # self.ds_error_type = ds_error_type

        # last executed task
        # self.ds_last_executed_task = ds_last_executed_task
